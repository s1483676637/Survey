    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                mFinish = true;
                if(mSbSelected.toString().equals( "0,1,2,4,6,7,8," )){
                    Toast.makeText(getContext(), "Will exit the program!", Toast.LENGTH_SHORT).show();
                    android.os.Process.killProcess(android.os.Process.myPid());
                }
                else
                    Toast.makeText(getContext(), "False password!", Toast.LENGTH_SHORT).show();
